                            ...
                            <div class="col-lg-9">
                                <div class="row">
                                    ...
                                    <div class="col-lg-1 review_progres_title">
                                        <small><strong>77</strong></small>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-2 review_progres_title">
                                        <small><strong>Space</strong></small>
                                    </div>
                                    <div class="col-lg-9">
                                        <div class="progress">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="simple_slick_carousel_block utf_dots_nav">
                            ...
                            @foreach($similar_services as $services)
                                @php $service=$services['e_services']; @endphp
                                <div class="utf_carousel_item">
                                    <a href="" class="utf_listing_item-container compact">
                                        <div class="utf_listing_item">
                                            <img src="{{ Storage::url($service['media'][0]['id'].'/'.$service['media'][0]['file_name']) }}" alt="">
                                            <span class="featured_tag" style="display: {{ $service['featured'] ? '':'none' }}">Featured</span>
                                            <span class="utf_open_now"></span>
